 ...
 * проєкт багато за задумом — кожен прогін пише свою статтю. Приховати частину
 * означало б, що глибоке посилання з панелі веде на картку, якої в стрічці
 * немає. Замість цього кожна картка помічена своїм походженням.
 */
