  ...
  after(async () => {
    ...
    const timers = PROGRESS.map((variants, index) =>
      setTimeout(
        ...
        // Крок росте разом із вікном очікування в askOrchestrator (240 с):
        // репліки мусять доживати до кінця, інакше після останньої настає
        // тиша на кілька хвилин — а саме тиша й змушує натиснути вдруге.
        6000 + index * 45000,
      ),
    );
