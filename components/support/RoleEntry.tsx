  ...
  return (
    <div className="stage">
      <div className="chooser">
        ...
        <p className="hint">
          Рішення про передачу людині ухвалює код (<code>pairly/decide.py</code>), а не
          модель: у датасеті кожен випадок має рівно один правильний вихід. Під кожною
          відповіддю бота видно статті бази знань, на які він спирався — якщо джерел
          немає, розмова йде в чергу, а не отримує вигадану відповідь.
        </p>
      </div>
    </div>
  );
