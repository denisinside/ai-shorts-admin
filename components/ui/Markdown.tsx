 ...
 *
 * Експортується, бо той самий інлайн потрібен реплікам чату WaitBot
 * (`components/reader/SlangText.tsx`): там поверх нього ще шукаються терміни
 * словника, тому в чаті власний рендерер, а не цей компонент. Але РОЗБІР має
 * бути один: два різні набори регекспів означали б, що в чаті й у статті
 * `**жирний**` працює по-різному.
 */
